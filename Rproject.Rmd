...
topcountries.gdp2019 <- top.countries %>% merge(dataGDP2019, by = "country") %>% merge(datapop, by = "country")
topcountries.gdp2019 <- topcountries.gdp2019[,(names(topcountries.gdp2019) %in% c("country","confirmed","GDP","death.rate","recovered.rate","Population (2020)"))]
...
```{r}
topcountries.gdp2019 <- topcountries.gdp2019[,(names(topcountries.gdp2019) %in% c("country","GDP","death.rate","recovered.rate","confirmed.rate"))]
#View(topcountries.gdp2019)
...
norm_data = as.data.frame(apply(topcountries.gdp2019[,2:5],2,normalize))
View(norm_data)
...
#View(data.longGDP)
ggplot(data.longGDP,aes(country,Type,fill=count))+
  geom_tile() +
